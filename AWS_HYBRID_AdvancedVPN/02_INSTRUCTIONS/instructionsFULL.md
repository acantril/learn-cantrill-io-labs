...
# STAGE 1 - INITIAL SETUP OF AWS ENVIRONMENT AND SIMULATED ON-PREMISES ENVIRONMENT
...
# STAGE 2 - CREATE CUSTOMER GATEWAY OBJECTS 
...
# STAGE 3 - CREATE VPN ATTACHMENTS FOR TRANSIT GATEWAY
...
# STAGE 4 - POPULATE DEMO VALUE TEMPLATE WITH ALL CONFIG VALUES

Populate the DemoValueTemplate, instructions are in that template.


# STAGE 5 - CONFIGURE IPSEC TUNNELS FOR ONPREMISES-ROUTER1
...
# STAGE 6 - CONFIGURE BGP ROUTING FOR ONPREMISES-ROUTER1 AND TEST
...
# STAGE 7 - CONFIGURE IPSEC TUNNELS FOR ONPREMISES-ROUTER2
...
# STAGE 8 - CONFIGURE BGP ROUTING FOR ONPREMISES-ROUTER2 AND TEST
